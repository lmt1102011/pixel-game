const SOULRIFT_CACHE = "soulrift-pwa-20260607-combat-allocation-cache-298";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-combat-allocation-cache-298",
  "./src/pwa.js?v=20260607-combat-allocation-cache-298",
  "./src/game.js?v=20260607-combat-allocation-cache-298",
  "./manifest.webmanifest?v=20260607-combat-allocation-cache-298",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-combat-allocation-cache-298",
  "./assets/exported-atlas/atlas-manifest.json?v=20260607-combat-allocation-cache-298",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-combat-allocation-cache-298"
];
