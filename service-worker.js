const SOULRIFT_CACHE = "soulrift-pwa-20260607-combat-query-pool-282";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-combat-query-pool-282",
  "./src/pwa.js?v=20260607-combat-query-pool-282",
  "./src/game.js?v=20260607-combat-query-pool-282",
  "./manifest.webmanifest?v=20260607-combat-query-pool-282",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-combat-query-pool-282",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-combat-query-pool-282"
];
