const SOULRIFT_CACHE = "soulrift-pwa-20260718-pixel-vfx-364";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260718-pixel-vfx-364",
  "./src/pwa.js?v=20260718-pixel-vfx-364",
  "./src/game.js?v=20260718-pixel-vfx-364",
  "./manifest.webmanifest?v=20260718-pixel-vfx-364",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260718-pixel-vfx-364",
  "./assets/exported-atlas/atlas-manifest.json?v=20260718-pixel-vfx-364",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260718-pixel-vfx-364"
];
