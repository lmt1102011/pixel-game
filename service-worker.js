const SOULRIFT_CACHE = "soulrift-pwa-20260607-enemy-spatial-grid-291";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-enemy-spatial-grid-291",
  "./src/pwa.js?v=20260607-enemy-spatial-grid-291",
  "./src/game.js?v=20260607-enemy-spatial-grid-291",
  "./manifest.webmanifest?v=20260607-enemy-spatial-grid-291",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-enemy-spatial-grid-291",
  "./assets/exported-atlas/atlas-manifest.json?v=20260607-enemy-spatial-grid-291",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-enemy-spatial-grid-291"
];
