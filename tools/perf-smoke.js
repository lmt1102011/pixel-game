    ...
    return new Promise((resolve) => {
      ...
      const tick = (now) => {
        ...
        resolve({
          ...
          audioNoiseBuffers: game.audio?.noiseBuffers?.size || 0,
          audioNoiseBufferBuilds: game.audio?.noiseBufferBuilds || 0,
          audioNoiseBufferUses: game.audio?.noiseBufferUses || 0,
