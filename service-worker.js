const SOULRIFT_CACHE = "soulrift-pwa-20260607-mobile-smooth-277";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-mobile-smooth-277",
  "./src/pwa.js?v=20260607-mobile-smooth-277",
  "./src/game.js?v=20260607-mobile-smooth-277",
  "./manifest.webmanifest?v=20260607-mobile-smooth-277",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-mobile-smooth-277",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-mobile-smooth-277"
];
