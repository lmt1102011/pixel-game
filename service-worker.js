const SOULRIFT_CACHE = "soulrift-pwa-20260607-frame-load-cache-295";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-frame-load-cache-295",
  "./src/pwa.js?v=20260607-frame-load-cache-295",
  "./src/game.js?v=20260607-frame-load-cache-295",
  "./manifest.webmanifest?v=20260607-frame-load-cache-295",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-frame-load-cache-295",
  "./assets/exported-atlas/atlas-manifest.json?v=20260607-frame-load-cache-295",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-frame-load-cache-295"
];
