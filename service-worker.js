const SOULRIFT_CACHE = "soulrift-pwa-20260607-engine-opt-278";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-engine-opt-278",
  "./src/pwa.js?v=20260607-engine-opt-278",
  "./src/game.js?v=20260607-engine-opt-278",
  "./manifest.webmanifest?v=20260607-engine-opt-278",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-engine-opt-278",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-engine-opt-278"
];
