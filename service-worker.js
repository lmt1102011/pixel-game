const SOULRIFT_CACHE = "soulrift-pwa-20260607-headroom-visual-cache-300";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-headroom-visual-cache-300",
  "./src/pwa.js?v=20260607-headroom-visual-cache-300",
  "./src/game.js?v=20260607-headroom-visual-cache-300",
  "./manifest.webmanifest?v=20260607-headroom-visual-cache-300",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-headroom-visual-cache-300",
  "./assets/exported-atlas/atlas-manifest.json?v=20260607-headroom-visual-cache-300",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-headroom-visual-cache-300"
];
