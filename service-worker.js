const SOULRIFT_CACHE = "soulrift-pwa-20260606-squad-level-plus-212";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260606-squad-level-plus-212",
  "./src/pwa.js?v=20260606-squad-level-plus-212",
  "./src/game.js?v=20260606-squad-level-plus-212",
  "./manifest.webmanifest?v=20260606-squad-level-plus-212",
  "./version.json",
