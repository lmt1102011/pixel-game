const SOULRIFT_CACHE = "soulrift-pwa-20260607-no-default-aura-304";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-no-default-aura-304",
  "./src/pwa.js?v=20260607-no-default-aura-304",
  "./src/game.js?v=20260607-no-default-aura-304",
  "./manifest.webmanifest?v=20260607-no-default-aura-304",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-no-default-aura-304",
  "./assets/exported-atlas/atlas-manifest.json?v=20260607-no-default-aura-304",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-no-default-aura-304"
];
