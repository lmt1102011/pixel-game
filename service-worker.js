const SOULRIFT_CACHE = "soulrift-pwa-20260607-premium-audio-texture-299";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-premium-audio-texture-299",
  "./src/pwa.js?v=20260607-premium-audio-texture-299",
  "./src/game.js?v=20260607-premium-audio-texture-299",
  "./manifest.webmanifest?v=20260607-premium-audio-texture-299",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-premium-audio-texture-299",
  "./assets/exported-atlas/atlas-manifest.json?v=20260607-premium-audio-texture-299",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-premium-audio-texture-299"
];
