const SOULRIFT_CACHE = "soulrift-pwa-20260606-scifi-skill-vfx-187";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260606-scifi-skill-vfx-187",
  "./src/pwa.js?v=20260606-scifi-skill-vfx-187",
  "./src/game.js?v=20260606-scifi-skill-vfx-187",
  "./manifest.webmanifest?v=20260606-scifi-skill-vfx-187",
  "./version.json",
