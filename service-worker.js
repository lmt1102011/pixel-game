const SOULRIFT_CACHE = "soulrift-pwa-20260607-fidelity-floor-274";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-fidelity-floor-274",
  "./src/pwa.js?v=20260607-fidelity-floor-274",
  "./src/game.js?v=20260607-fidelity-floor-274",
  "./manifest.webmanifest?v=20260607-fidelity-floor-274",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-fidelity-floor-274",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-fidelity-floor-274"
];
