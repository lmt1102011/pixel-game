const SOULRIFT_CACHE = "soulrift-pwa-20260607-preload-hotfix-272";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-preload-hotfix-272",
  "./src/pwa.js?v=20260607-preload-hotfix-272",
  "./src/game.js?v=20260607-preload-hotfix-272",
  "./manifest.webmanifest?v=20260607-preload-hotfix-272",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-preload-hotfix-272",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-preload-hotfix-272"
];
