const SOULRIFT_CACHE = "soulrift-pwa-20260607-query-buffer-clean-283";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-query-buffer-clean-283",
  "./src/pwa.js?v=20260607-query-buffer-clean-283",
  "./src/game.js?v=20260607-query-buffer-clean-283",
  "./manifest.webmanifest?v=20260607-query-buffer-clean-283",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-query-buffer-clean-283",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-query-buffer-clean-283"
];
