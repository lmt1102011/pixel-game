const SOULRIFT_CACHE = "soulrift-pwa-20260607-training-exit-253";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-training-exit-253",
  "./src/pwa.js?v=20260607-training-exit-253",
  "./src/game.js?v=20260607-training-exit-253",
  "./manifest.webmanifest?v=20260607-training-exit-253",
  "./version.json",
  ...
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-training-exit-253"
];
