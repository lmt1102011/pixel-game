const SOULRIFT_CACHE = "soulrift-pwa-20260606-mobile-menu-fix-217";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260606-mobile-menu-fix-217",
  "./src/pwa.js?v=20260606-mobile-menu-fix-217",
  "./src/game.js?v=20260606-mobile-menu-fix-217",
  "./manifest.webmanifest?v=20260606-mobile-menu-fix-217",
  "./version.json",
