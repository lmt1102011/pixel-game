const SOULRIFT_CACHE = "soulrift-pwa-20260607-resize-stability-281";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-resize-stability-281",
  "./src/pwa.js?v=20260607-resize-stability-281",
  "./src/game.js?v=20260607-resize-stability-281",
  "./manifest.webmanifest?v=20260607-resize-stability-281",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-resize-stability-281",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-resize-stability-281"
];
