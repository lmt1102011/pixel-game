const SOULRIFT_CACHE = "soulrift-pwa-20260607-resize-lock-273";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-resize-lock-273",
  "./src/pwa.js?v=20260607-resize-lock-273",
  "./src/game.js?v=20260607-resize-lock-273",
  "./manifest.webmanifest?v=20260607-resize-lock-273",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-resize-lock-273",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-resize-lock-273"
];
