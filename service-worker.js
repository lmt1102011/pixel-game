const SOULRIFT_CACHE = "soulrift-pwa-20260607-room-pattern-cache-290";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-room-pattern-cache-290",
  "./src/pwa.js?v=20260607-room-pattern-cache-290",
  "./src/game.js?v=20260607-room-pattern-cache-290",
  "./manifest.webmanifest?v=20260607-room-pattern-cache-290",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-room-pattern-cache-290",
  "./assets/exported-atlas/atlas-manifest.json?v=20260607-room-pattern-cache-290",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-room-pattern-cache-290"
];
