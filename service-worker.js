const SOULRIFT_CACHE = "soulrift-pwa-20260607-stable-frames-275";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-stable-frames-275",
  "./src/pwa.js?v=20260607-stable-frames-275",
  "./src/game.js?v=20260607-stable-frames-275",
  "./manifest.webmanifest?v=20260607-stable-frames-275",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-stable-frames-275",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-stable-frames-275"
];
