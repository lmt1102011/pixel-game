const SOULRIFT_CACHE = "soulrift-pwa-20260607-touch-comfort-276";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-touch-comfort-276",
  "./src/pwa.js?v=20260607-touch-comfort-276",
  "./src/game.js?v=20260607-touch-comfort-276",
  "./manifest.webmanifest?v=20260607-touch-comfort-276",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-touch-comfort-276",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-touch-comfort-276"
];
