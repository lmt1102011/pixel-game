const SOULRIFT_CACHE = "soulrift-pwa-20260607-exit-inline-252";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-exit-inline-252",
  "./src/pwa.js?v=20260607-exit-inline-252",
  "./src/game.js?v=20260607-exit-inline-252",
  "./manifest.webmanifest?v=20260607-exit-inline-252",
  "./version.json",
  ...
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-exit-inline-252"
];
