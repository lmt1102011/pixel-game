const SOULRIFT_CACHE = "soulrift-pwa-20260609-minecraft-smooth-room-311";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260609-minecraft-smooth-room-311",
  "./src/pwa.js?v=20260609-minecraft-smooth-room-311",
  "./src/game.js?v=20260609-minecraft-smooth-room-311",
  "./manifest.webmanifest?v=20260609-minecraft-smooth-room-311",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260609-minecraft-smooth-room-311",
  "./assets/exported-atlas/atlas-manifest.json?v=20260609-minecraft-smooth-room-311",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260609-minecraft-smooth-room-311"
];
