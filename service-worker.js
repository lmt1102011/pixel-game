const SOULRIFT_CACHE = "soulrift-pwa-20260607-realistic-audio-288";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-realistic-audio-288",
  "./src/pwa.js?v=20260607-realistic-audio-288",
  "./src/game.js?v=20260607-realistic-audio-288",
  "./manifest.webmanifest?v=20260607-realistic-audio-288",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-realistic-audio-288",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-realistic-audio-288"
];
