const SOULRIFT_CACHE = "soulrift-pwa-20260607-frame-preload-254";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260607-frame-preload-254",
  "./src/pwa.js?v=20260607-frame-preload-254",
  "./src/game.js?v=20260607-frame-preload-254",
  "./manifest.webmanifest?v=20260607-frame-preload-254",
  "./version.json",
  ...
  "./assets/exported/asset-manifest.json?v=20260607-frame-preload-254",
  "./assets/sprites/monsters/shadow-goblin.png?v=20260607-frame-preload-254"
];
