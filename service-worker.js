const SOULRIFT_CACHE = "soulrift-pwa-20260606-squad-mode-repair-227";
const SOULRIFT_ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=20260606-squad-mode-repair-227",
  "./src/pwa.js?v=20260606-squad-mode-repair-227",
  "./src/game.js?v=20260606-squad-mode-repair-227",
  "./manifest.webmanifest?v=20260606-squad-mode-repair-227",
  "./version.json",
